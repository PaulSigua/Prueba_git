...
public class Inicio {
    ...
    public static void listarPersonas(ArrayList<? extends Persona> lista) {
        for (Object p : lista) {
            if (p instanceof Persona) {
                ...
                System.out.println("No fue posible imprimir al Docente");
            } 
            else if(p instanceof Admin){
                System.out.println("No fue posible imprimir el Admin");
            }
            else {
