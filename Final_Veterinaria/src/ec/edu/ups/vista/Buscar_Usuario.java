...
public class Buscar_Usuario extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(rad_Cedula, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 180, -1, -1));

        rad_Nombre.setFont(new java.awt.Font("Calibri", 1, 14)); // NOI18N
        rad_Nombre.setText("Nombre de Usuario");
        jPanel1.add(rad_Nombre, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 180, -1, -1));
    ...
    private void btn_BuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_BuscarActionPerformed
        if (txt_Cedula.getText().trim().equals("")) {
            ...
            if (rad_Cedula.isSelected()) {
                List<Usuario> usuarios = this.controladorUsuario.buscarUsuarioCedula(txt_Cedula.getText().trim());
                if (usuarios != null) {
                    this.vent_Usuarios.resultadoBusqueda(usuarios);
                    this.dispose();
                }
            } else if (rad_Nombre.isSelected()) {
                List<Usuario> usuarios = this.controladorUsuario.buscarUsuarioNombre(txt_Cedula.getText().trim());
                if (usuarios != null) {
                    this.vent_Usuarios.resultadoBusqueda(usuarios);
                    this.dispose();
                }
