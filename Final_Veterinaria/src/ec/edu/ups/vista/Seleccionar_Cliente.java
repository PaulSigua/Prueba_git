...
public class Seleccionar_Cliente extends javax.swing.JFrame {
    ...
    public void actulizarTabla() {
        listaClientes = this.controladorPersona.listarClientes();
        List<Persona> listaFiltrada = new ArrayList<>();
        for (Persona listaCliente : listaClientes) {
            if (listaCliente.getEstado() == 'S') {
                listaFiltrada.add(listaCliente);
            }
        }
        ...
        for (Persona per : listaActual) {
            ...
            Object[] fila = {per.getCedula(), per.getNombre(), per.getApellido(), per.getTipo()};
            modelo.addRow(fila);
        }
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ec/edu/ups/imagenes/SeleccionarCliente.png"))); // NOI18N
    ...
    private void btn_BuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_BuscarActionPerformed
        if (txt_Cedula.getText().trim().equals("")) {
            ...
            if (rad_Cedula.isSelected()) {
                ...
                if (personas != null ) {
                    List<Persona> listaFiltrada = new ArrayList<>();
                    for (Persona listaCliente : personas) {
                        if (listaCliente.getEstado() == 'S') {
                            listaFiltrada.add(listaCliente);
                        }
                    }
                    this.resultadoBusqueda(listaFiltrada);
    ...
    private void btn_AceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_AceptarActionPerformed
        if (this.vent_Mascotas == null) {
            if (personaSeleccionada != null) {
                this.vent_Facturar1.setClienteSeleccionado(personaSeleccionada);
                this.dispose();
            } else {
            ...
            if (personaSeleccionada != null) {
                this.vent_Mascotas.setClienteSeleccionado(personaSeleccionada);
                this.dispose();
            } else {
                JOptionPane.showMessageDialog(null, "SElECCIONE A UN CLIENTE");
            }
