...
public class Buscar_Mascota extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(rad_Cedula, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 180, -1, -1));

        rad_Nombre.setFont(new java.awt.Font("Calibri", 1, 14)); // NOI18N
        rad_Nombre.setText("Nombre de  la Mascota");
        jPanel1.add(rad_Nombre, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 180, -1, -1));
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ec/edu/ups/imagenes/BuscarMascota.png"))); // NOI18N
    ...
    private void btn_BuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_BuscarActionPerformed
        if (txt_Cedula.getText().trim().equals("")) {
            ...
            if (rad_Cedula.isSelected()) {
                ...
                if (mascotas != null) {
                    this.vent_Mascotas.resultadoBusqueda(mascotas);
                    this.dispose();
                }
