...
public class Vent_Clientes extends javax.swing.JInternalFrame {
    ...
    public void actulizarTabla() {
        ...
        for (Persona per : listaClientes) {
            ...
            Object[] fila = {per.getId(), per.getCedula(), per.getNombre(), per.getApellido(), per.getDireccion(), per.getTelefono(), per.getCorreo(), estado};
            modelo.addRow(fila);
        }
    ...
    private void initComponents() {
        ...
        jPanel1.add(combo_Estado, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 280, 200, 30));
        ...
        tabla_Clientes.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "id", "Cedula", "Nombre", "Apellido", "Direccion", "Telefono", "Correo", "Estado"
            }
        ) {
        ...
        if (tabla_Clientes.getColumnModel().getColumnCount() > 0) {
            tabla_Clientes.getColumnModel().getColumn(0).setPreferredWidth(1);
        }

        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 320, 840, 280));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ec/edu/ups/imagenes/Clientes.png"))); // NOI18N
    ...
    private void btn_EliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_EliminarActionPerformed
        ...
        int result = JOptionPane.showOptionDialog(null, "¿Eliminar Cliente= "+personaSeleccionada.getNombre()+"?", "Confirmación",
    ...
    private void btn_RegistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_RegistrarActionPerformed
        if (txt_Cedula.getText().trim().isEmpty() || txt_Apellidos.getText().trim().isEmpty() || txt_Nombres.getText().trim().isEmpty()
            ...
            this.controladorPersona.registrarPersona(new Persona(0, txt_Cedula.getText().trim(), txt_Nombres.getText().trim(), txt_Apellidos.getText().trim(),
                    txt_Direccion.getText().trim(), txt_Telefono.getText().trim(), txt_Correo.getText().trim(), 'C', 'S'));
        }
        resetear();
        actulizarTabla();
    ...
    private void btn_BuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_BuscarActionPerformed
        Buscar_Cliente bs = new Buscar_Cliente();
        bs.setVent_Clientes(this);
        bs.setControladorPersona(this.controladorPersona);
        bs.setVisible(true);
